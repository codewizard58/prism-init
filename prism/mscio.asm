	TITLE	MSCIO Module. 17-April-1992
...
;
;
DGROUP	GROUP	MSCIODAT
MSCIODAT	SEGMENT	WORD PUBLIC 'DATA'
	ASSUME	DS:MSCIODAT
	public	_spd,_sch,_alltx,_goodtx
	...
	xofsnt	db	0
	xofrcv	db	0
	_spd	dw	0	; port speed 
	_sch	db	0	; passed char to send to port
; more tx stuff
...
_PROG	SEGMENT	BYTE PUBLIC 'PROG'
	...
	PUBLIC	_serini, _setspd, _serput, _serget
	PUBLIC  _serrst, _clrbuf, _chaval
	public	_setbeat, _gettick
...
; timer int 8 (20h)
	...
	mov	ah,35h
	int	21h
	mov	word ptr cs:tvip,bx
	mov	bx,es
	mov	word ptr cs:tvseg,bx
